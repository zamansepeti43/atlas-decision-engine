...
export interface ResearchStatus { requested: boolean; status: "not_requested" | "completed" | "unavailable" | "failed"; error?: string; provider?: "tavily"; httpStatus?: number; retrievedAt?: string; }
export interface NearbyPriceInsight { marketName: string; distanceMeters: number; productName: string; priceTRY: number; url: string; exactMatch: boolean; verification: "merchant_page" | "search_snapshot"; retrievedAt: string; }
